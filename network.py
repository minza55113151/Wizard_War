...
class Network:
    ...
    def set_client_sending_data(self, client_sending_data):
    ...
    def reset_client_sending_data(self, player=None):
    ...
    def valid_player_client_data(self):
        for player_id, player in list(self.client_data["player"].items()):
            if player_id not in self.server_data["player"]:
                player["player"].kill()
                del self.client_data["player"][player_id]

    def update_client_data(self):
        self.valid_player_client_data()
